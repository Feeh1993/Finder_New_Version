...
public class Ajuda_CriarAnuncio extends OnboarderActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        // Criar paginas
        OnboarderPage onboarderPage1 = new OnboarderPage("Seja bem vindo ao Finder", "Voce verá a seguir como criar seus anuncios!",R.drawable.logo1);
        OnboarderPage onboarderPage2 = new OnboarderPage("Veja aquilo que voce realmente quer ver", "Comece inserindo os dados dos Produtos(nome,preço,tipo,descrição,categoria e subcategoria!", R.drawable.visualize_inicio);
        OnboarderPage onboarderPage3 = new OnboarderPage("Receba notificações dos produtos", "Ao salvar, uma nova tela aparecera,selecione a data de validade dos seus produtos!",R.drawable.not_inicio);
        OnboarderPage onboarderPage4 = new OnboarderPage("Tudo na palma da sua mão", "E por fim!Selecione as imagens para a apresentação dos seus Produtos! Simples né?", R.drawable.palma_inicio);
